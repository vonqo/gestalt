...
* GStreamer 1
  * GStreamer Base Plugins
  ...
  #### OS X
  ````sh 
  sudo port install gstreamer1 gstreamer1-gst-libav gstreamer1-gst-plugins-bad gstreamer1-gst-plugins-base gstreamer1-gst-plugins-good gstreamer1-gst-plugins-ugly 
  ````
