...
public class LunarTearHqz {
    ...
    // ========================= MATERIALS ========================= //
    // ============================================================= //
    private List<Material> buildMaterials(LunarTearHqz.Types types) {
        List<Material> materials = new ArrayList<Material>();
        materials.add(HQZUtils.buildMaterial(0.0f,0.0f,1.0f));

        if(types == LunarTearHqz.Types.TEST1 || types == LunarTearHqz.Types.TORNADO) {
    ...
    // ========================= OBJECTS =========================== //
    // ============================================================= //
    private List<ZObject> buildObjects(LunarTearHqz.Types types) {
