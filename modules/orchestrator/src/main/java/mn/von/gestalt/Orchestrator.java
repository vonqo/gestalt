...
//    }
    ...
    public static void main(String args[]) {
        ...
        String sogname = "e_hfalling";
        String displayText = "e_hfalling";
...
//            );
            ...
            spectrumizer.applyMoodbar(moodbar1);
            spectrumizer.build();
//
//            // save with rotation
...
//             hqzAdapter.buildHQZ(moodbar, spectrumizer.getDATA(), ",Harry Styles - Falling", "harry_falling.png");
             hqzAdapter.buildHQZ(moodbar1, spectrumizer.getDATA(), ",Jaden Smith - Fallen", "jaden_fallen.png");
//             hqzAdapter.buildHQZ(moodbar2, spectrumizer.getDATA(), ",Mac Miller - Ave Maria", "mac.png");
